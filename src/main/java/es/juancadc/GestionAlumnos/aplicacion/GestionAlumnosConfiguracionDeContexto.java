package es.juancadc.GestionAlumnos.aplicacion;
...
public class GestionAlumnosConfiguracionDeContexto {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactory.setPackagesToScan(AlumnosDAO.class.getPackage().getName());
